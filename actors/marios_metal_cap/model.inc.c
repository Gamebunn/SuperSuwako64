Lights1 marios_metal_cap_colors_f3d_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Gfx marios_metal_cap_suwako_colors_ci8_aligner[] = {gsSPEndDisplayList()};
u8 marios_metal_cap_suwako_colors_ci8[] = {
...
Gfx marios_metal_cap_suwako_colors_ci8_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 marios_metal_cap_suwako_colors_ci8_pal_rgba16[] = {
...
Vtx marios_metal_cap_000_displaylist_mesh_vtx_0[165] = {
...
Gfx marios_metal_cap_000_displaylist_mesh_tri_0[] = {
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 16, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 32, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 48, 14, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 62, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSP1Triangle(14, 13, 15, 0),
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 78, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	...
	gsSP1Triangle(14, 12, 13, 0),
	gsSP1Triangle(14, 13, 15, 0),
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 94, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(4, 3, 0, 0),
	gsSP1Triangle(4, 5, 3, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 110, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(4, 3, 0, 0),
	gsSP1Triangle(4, 5, 3, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 126, 15, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(3, 0, 2, 0),
	...
	gsSP1Triangle(12, 13, 11, 0),
	gsSP1Triangle(14, 13, 12, 0),
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 141, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPVertex(marios_metal_cap_000_displaylist_mesh_vtx_0 + 157, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(3, 2, 4, 0),
	gsSP1Triangle(3, 4, 5, 0),
...
Gfx mat_marios_metal_cap_colors_f3d[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, marios_metal_cap_suwako_colors_ci8_pal_rgba16),
	gsDPTileSync(),
	...
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_8b, 32, marios_metal_cap_suwako_colors_ci8),
	...
	gsSPSetLights1(marios_metal_cap_colors_f3d_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_marios_metal_cap_colors_f3d[] = {
	gsDPPipeSync(),
...
Gfx mat_marios_metal_cap_metal[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT),
	gsSPSetGeometryMode(G_TEXTURE_GEN),
	gsSPTexture(4031, 1983, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, marios_metal_cap_metal_rgba16),
...
Gfx mat_revert_marios_metal_cap_metal[] = {
	gsDPPipeSync(),
...
Gfx marios_metal_cap_000_displaylist_mesh[] = {
	gsSPDisplayList(mat_marios_metal_cap_colors_f3d),
	gsSPDisplayList(marios_metal_cap_000_displaylist_mesh_tri_0),
	gsSPDisplayList(mat_revert_marios_metal_cap_colors_f3d),
	gsSPEndDisplayList(),
};

Gfx marios_metal_cap_000_displaylist_mesh_mat_override_metal_0[] = {
	gsSPDisplayList(mat_marios_metal_cap_metal),
	gsSPDisplayList(marios_metal_cap_000_displaylist_mesh_tri_0),
	gsSPDisplayList(mat_revert_marios_metal_cap_metal),
	gsSPEndDisplayList(),
};
