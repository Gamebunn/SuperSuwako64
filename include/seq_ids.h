...
enum SeqId {
    ...
    SEQ_STREAMED_NEWCASTLE,
    SEQ_STREAMED_NEWGRASS,
    SEQ_STREAMED_NEWBOSS,
    SEQ_STREAMED_NEWWATER,
    SEQ_STREAMED_NEWSNOW,
    SEQ_STREAMED_NEWKOOPAROAD,
    SEQ_STREAMED_NEWBOSWER1,
    SEQ_STREAMED_NEWBOWSER2,
    SEQ_STREAMED_NEWBOO,
    SEQ_STREAMED_NEWMERRYGOROUND,
    SEQ_STREAMED_NEWCAVE,
    SEQ_STREAMED_NEWHOT,
    SEQ_STREAMED_NEWSKY,
    SEQ_STREAMED_NEWCREDITS,
    SEQ_STREAMED_NEWMETALCAP,
    SEQ_STREAMED_NEWPOWERUP,
    SEQ_COUNT
};
